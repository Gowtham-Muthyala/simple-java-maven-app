...
# RUN npm install 
# RUN npm start 
ADD /var/lib/jenkins/workspace/sample-docker-output/target/my-app-1.0-SNAPSHOT.jar /var/lib/jenkins/workspace/sample-docker-output/target/my-app-1.0-SNAPSHOT.jar
